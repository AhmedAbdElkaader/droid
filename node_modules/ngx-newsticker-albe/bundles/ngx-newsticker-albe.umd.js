(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-newsticker-albe', ['exports', '@angular/core', '@angular/common'], factory) :
    (global = global || self, factory(global['ngx-newsticker-albe'] = {}, global.ng.core, global.ng.common));
    ...
    var NgxNewstickerAlbeComponent = /** @class */ (function () {
        ...
        NgxNewstickerAlbeComponent.propDecorators = {
            ...
            showCounter: [{ type: core.Input }],
            defaultColor: [{ type: core.Input }],
            backColor: [{ type: core.Input }],
            ntRef: [{ type: core.ViewChild, args: ['nt', { static: true },] }],
            ntCounterRef: [{ type: core.ViewChild, args: ['ntCounter', { static: true },] }],
            ntTitleRef: [{ type: core.ViewChild, args: ['ntTitle', { static: true },] }],
            nDart: [{ type: core.ViewChild, args: ['nDart', { static: true },] }],
            ntNaviRef: [{ type: core.ViewChildren, args: ['ntNavi',] }],
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var NgxNewstickerAlbeModule = /** @class */ (function () {
        function NgxNewstickerAlbeModule() {
        }
        ...
        return NgxNewstickerAlbeModule;
    }());

    exports.NgxNewstickerAlbeComponent = NgxNewstickerAlbeComponent;
    exports.NgxNewstickerAlbeModule = NgxNewstickerAlbeModule;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=ngx-newsticker-albe.umd.js.map
